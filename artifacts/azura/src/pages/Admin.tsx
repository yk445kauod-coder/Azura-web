...
type ActiveTab = "overview" | "menu" | "features" | "users" | "chat" | "reviews" | "broadcast" | "reels" | "barista" | "api" | "system" | "tables" | "ai";
...
export default function Admin() {
  ...
  const TABS: { id: ActiveTab; icon: any; en: string; ar: string; badge?: number }[] = [
